...
<div id="schedule">
	...
	<h3><?php echo Yii::t('strings','Re-schedule Operation')?></h3>
	...
	<div class="eventDetail">
		<strong><?php echo Yii::t('strings','Operation duration')?>:</strong> <?php echo $operation->total_duration; ?> <?php echo Yii::t('strings','minutes')?>
	</div>
	
	<div class="eventDetail">
                <div class="label"><strong><?php echo Yii::t('strings','Current schedule')?>:</strong></div>
