...
class m130806_132333_element_type_priority_fields extends CDbMigration
{
	public function up()
	{
		$this->addColumn('element_type_priority','created_user_id','int(10) unsigned NOT NULL');
		...
		$this->addColumn('element_type_priority','last_modified_user_id','int(10) unsigned NOT NULL');
