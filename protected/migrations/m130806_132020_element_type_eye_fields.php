...
class m130806_132020_element_type_eye_fields extends CDbMigration
{
	public function up()
	{
		$this->addColumn('element_type_eye','created_user_id','int(10) unsigned NOT NULL');
		...
		$this->addColumn('element_type_eye','last_modified_user_id','int(10) unsigned NOT NULL');
