...
<div class="StringList">
	...
	<ul class="StringList"<?php if ($disabled) {?> disabled="disabled"<?php }?>>
		...
		<?php }?>
		<li>
			<?php echo CHtml::textField('stringlistadd_'.$field,'',array('class'=>'StringListAddText','disabled'=>$disabled))?>
			<?php echo EventAction::button('Add', 'sladd_'.$field, array('colour' => 'blue'), array('class' => 'StringListAdd'.($disabled?' inactive':''),'disabled'=>$disabled))->toHtml()?>
		</li>
	</ul>
</div>
