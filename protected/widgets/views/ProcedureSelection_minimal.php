...
<script type="text/javascript">
	...
	public function updateTotalDuration(identifier)
	{
	...
	public function removeProcedure(element, identifier)
	{
	...
	public function selectSort(a, b)
	{
			if (a.innerHTML == rootItem) {
					return -1;
			} elseif (b.innerHTML == rootItem) {
					return 1;
			}
	...
	public function updateProcedureSelect(identifier)
	{
	...
	public function ProcedureSelectionSelectByName(name, callback, identifier)
	{
		$.ajax({
