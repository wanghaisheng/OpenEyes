		...
		<?php echo CHtml::dropDownList('ParentEvent', @$_REQUEST['ParentEvent'], CHtml::listData(EventType::model()->findAll(array('order'=>'name asc','condition'=>'parent_id is null')),'class_name','name'), array('empty'=>'- None -'))?><br/>
