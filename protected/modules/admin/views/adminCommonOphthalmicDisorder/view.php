...
$this->menu=array(
	...
	array('label'=>Yii::t('strings','Update CommonOphthalmicDisorder'), 'url'=>array('update', 'id'=>$model->id)),
	array('label'=>Yii::t('strings','Delete CommonOphthalmicDisorder'), 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
	array('label'=>Yii::t('strings','Manage CommonOphthalmicDisorder'), 'url'=>array('admin')),
);
?>

<h1><?php echo Yii::t('strings','View CommonOphthalmicDisorder')?> #<?php echo $model->id; ?></h1>
