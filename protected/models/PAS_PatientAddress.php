...
class PAS_PatientAddress extends MultiActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'ADDR_TYPE' => Yii::t('strings','Addr Type'),
			...
			'ADDR1' => Yii::t('strings','Addr1'),
			'ADDR2' => Yii::t('strings','Addr2'),
			'ADDR3' => Yii::t('strings','Addr3'),
			'ADDR4' => Yii::t('strings','Addr4'),
			'ADDR5' => Yii::t('strings','Addr5'),
			'POSTCODE' => Yii::t('strings','Postcode'),
			'HA_CODE' => Yii::t('strings','Ha Code'),
			'TEL_NO' => Yii::t('strings','Tel No'),
			'DWELLING_TYPE' => Yii::t('strings','Dwelling Type'),
			'SHARING_ACCOM' => Yii::t('strings','Sharing Accom'),
