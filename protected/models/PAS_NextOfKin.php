...
class PAS_NextOfKin extends MultiActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'SEQ_NO' => Yii::t('strings','Seq No'),
			'NEXT_OF_KIN_RELATION' => Yii::t('strings','Next Of Kin Relation'),
			'REL_TEXT' => Yii::t('strings','Rel Text'),
			'DISC_IND' => Yii::t('strings','Disc Ind'),
			'TITLE' => Yii::t('strings','Title'),
			'SURNAME' => Yii::t('strings','Surname'),
			'FORENAME1' => Yii::t('strings','Forename1'),
			'ADDR_FORMAT' => Yii::t('strings','Addr Format'),
			'PROPERTY_NAME' => Yii::t('strings','Property Name'),
			'PROPERTY_NO' => Yii::t('strings','Property No'),
			'ADDRESS_LINE_1' => Yii::t('strings','Address Line 1'),
			'ADDRESS_LINE_2' => Yii::t('strings','Address Line 2'),
			'ADDRESS_LINE_3' => Yii::t('strings','Address Line 3'),
			'ADDRESS_LINE_4' => Yii::t('strings','Address Line 4'),
			'POSTCODE' => Yii::t('strings','Postcode'),
			'HOME_PHONE_NO' => Yii::t('strings','Home Phone No'),
			'DAY_PHONE_NO' => Yii::t('strings','Day Phone No'),
			'DATE_START' => Yii::t('strings','Date Start'),
			'DATE_END' => Yii::t('strings','Date End'),
			'HDDR_GROUP' => Yii::t('strings','Hddr Group'),
			'REL_STAT' => Yii::t('strings','Rel Stat'),
		);
	}
