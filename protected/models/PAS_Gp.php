...
class PAS_Gp extends MultiActiveRecord
{
	...
	{
		return array(
			'OBJ_TYPE' => Yii::t('strings','Obj Type'),
			'OBJ_PROF' => Yii::t('strings','Obj Prof'),
			'DATE_FR' => Yii::t('strings','Date Fr'),
			'SN' => Yii::t('strings','Sn'),
			'FN1' => Yii::t('strings','Fn1'),
			'FN2' => Yii::t('strings','Fn2'),
			'TITLE' => Yii::t('strings','Title'),
			'JOB_TTL' => Yii::t('strings','Job Ttl'),
			'BLEEP' => Yii::t('strings','Bleep'),
			'REG_ID' => Yii::t('strings','Reg'),
			'NAT_ID' => Yii::t('strings','Nat'),
			'GRADE' => Yii::t('strings','Grade'),
			'ADD_FORM' => Yii::t('strings','Add Form'),
			'ADD_NAM' => Yii::t('strings','Add Nam'),
			'ADD_NUM' => Yii::t('strings','Add Num'),
			'ADD_ST' => Yii::t('strings','Add St'),
			'ADD_DIS' => Yii::t('strings','Add Dis'),
			'ADD_TWN' => Yii::t('strings','Add Twn'),
			'ADD_CTY' => Yii::t('strings','Add Cty'),
			'ADD_CNT' => Yii::t('strings','Add Cnt'),
			'PC' => Yii::t('strings','Pc'),
			'CONTACT' => Yii::t('strings','Contact'),
			'TEL_1' => Yii::t('strings','Tel 1'),
			'TEL_2' => Yii::t('strings','Tel 2'),
			'FAX_1' => Yii::t('strings','Fax 1'),
			'FAX_2' => Yii::t('strings','Fax 2'),
			'COMMS' => Yii::t('strings','Comms'),
			'INTER' => Yii::t('strings','Inter'),
			'EMAIL' => Yii::t('strings','Email'),
			'PERS_NO' => Yii::t('strings','Pers No'),
			'COST' => Yii::t('strings','Cost'),
			'SURG' => Yii::t('strings','Surg'),
			'C_SPEC' => Yii::t('strings','C Spec'),
			'DATE_TO' => Yii::t('strings','Date To'),
