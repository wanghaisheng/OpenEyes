...
class PAS_Referral extends MultiActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'X_CN' => Yii::t('strings','X Cn'),
			'DATEX' => Yii::t('strings','Datex'),
			'TIMEX' => Yii::t('strings','Timex'),
			'METHOD' => Yii::t('strings','Method'),
			'DT_REC' => Yii::t('strings','Dt Rec'),
			'REC_LOC' => Yii::t('strings','Rec Loc'),
			'SRCE_REF' => Yii::t('strings','Srce Ref'),
			'S_TYPE' => Yii::t('strings','S Type'),
			'SOURCE' => Yii::t('strings','Source'),
			'P_TYPE' => Yii::t('strings','P Type'),
			'REF_PERS' => Yii::t('strings','Ref Pers'),
			'DISCIP' => Yii::t('strings','Discip'),
			'REASON' => Yii::t('strings','Reason'),
			'PRIORITY' => Yii::t('strings','Priority'),
			'CANCER' => Yii::t('strings','Cancer'),
			'CAN_TYPE' => Yii::t('strings','Can Type'),
			'REF' => Yii::t('strings','Ref'),
			'REF_TO' => Yii::t('strings','Ref To'),
			'REF_SPEC' => Yii::t('strings','Ref Spec'),
			'REF_TEXT' => Yii::t('strings','Ref Text'),
			'CUR_LOC' => Yii::t('strings','Cur Loc'),
			'DIAGTYPE' => Yii::t('strings','Diagtype'),
			'DIAGCODE' => Yii::t('strings','Diagcode'),
			'DIAGTEXT' => Yii::t('strings','Diagtext'),
			'DT_CLOSE' => Yii::t('strings','Dt Close'),
			'TM_CLOSE' => Yii::t('strings','Tm Close'),
			'PC_TYPE' => Yii::t('strings','Pc Type'),
			'CLS_PERS' => Yii::t('strings','Cls Pers'),
			'CLS_REAS' => Yii::t('strings','Cls Reas'),
			'HDDR_GROUP' => Yii::t('strings','Hddr Group'),
			'USED_COUNT' => Yii::t('strings','Used Count'),
			'USRCODET' => Yii::t('strings','Usrcodet'),
			'USRCODEC_1' => Yii::t('strings','Usrcodec 1'),
			'USRCODEC_2' => Yii::t('strings','Usrcodec 2'),
			'USRCODEC_3' => Yii::t('strings','Usrcodec 3'),
			'USRCODEC_4' => Yii::t('strings','Usrcodec 4'),
			'USRCODEC_5' => Yii::t('strings','Usrcodec 5'),
			'USRCODEC_6' => Yii::t('strings','Usrcodec 6'),
			'USRCODEC_7' => Yii::t('strings','Usrcodec 7'),
			'USRCODEC_8' => Yii::t('strings','Usrcodec 8'),
			'USRCODEC_9' => Yii::t('strings','Usrcodec 9'),
			'USRCODEC_10' => Yii::t('strings','Usrcodec 10'),
			'REF_ORG' => Yii::t('strings','Ref Org'),
			'RTT' => Yii::t('strings','Rtt'),
		);
	}
