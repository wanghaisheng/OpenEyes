						...
						<div class="box generic docs">
							...
							<div class="row">
								<div class="large-12 column">
									...
									<p>
										This page lists all the possible form fields and layouts to
										be used in the OpenEyes application. Use this documentation as a
										guide to creating forms throughout the application.
									</p>
								</div>
							</div>
							...
							<div class="row">
								<div class="large-12 column">
									...
									<p>
										Each field row is wrapped in a container, and labels are used to describe the fields. Fieldsets
										are used to wrap fields groups, like radio or checkbox groups.
									</p>
									<p>
										There are no set dimensions for the form components. This allows
										...
										are unfamiliar with how the grid system works, please view the <a href="#">grid documentation</a>.
									</p>
									...
									<form class="example" id="horizontal-layout-example">
										...
										<p>
											Fields will fill the width of their containers. To make a field
											...
											to the last column, if the combined columns don't equal 12.
										</p>
							...
							<div class="row">
								<div class="large-12 column">
									...
									<p>
										For the application to have consistent forms, it's important
									...
									<div class="example" id="select-dropdown-example">
										...
										<h4>When to use:</h4>
										<p>
											When asking the user to select exactly one option from a <em>large</em> list
											of options, where <em>not all</em> of the options are relevant to the user.
										</p>
										<h4>Rules:</h4>
										<ul>
										...
										<h4>Validation:</h4>
										<p>
											You can enforce a consious user selection by not making any of the
											options selected, and by adding an additional option at
											the top of the list with text "-- Select --" with a null value, for example:
										</p>
										<div class="field-row row">
											<div class="large-4 column end">
									...
									<div class="example" id="radio-input-example">
										...
										<h4>When to use:</h4>
										<p>
											When asking the user to select exactly one option from a <em>small</em> list
											of options, where <em>all</em> of the options are relevant to the user.
										</p>
										<h4>Rules:</h4>
										<ul>
										...
										<p>
											You can enforce a consious user selection by not making any of the
											radio inputs checked, for example:
										</p>
										<div class="field-row row">
											<div class="large-4 column end show-markup">
												<fieldset>
									...
									<div class="example" id="checkbox-input-example">
										...
										<h4>When to use:</h4>
										<p>
											When asking the user to select none, one or more options from a list
											of options.
										</p>
										<p>
									...
									<div class="example" id="textarea-example">
										...
										<ul>
											...
											<li>Make use of the placeholder attribute for a more descriptive label.</li>
											<li>Textareas should never be styled like a text input, the height of the textarea should always be at least 2 X line-height.</li>
										</ul>
										<h4>Example:</h4>
										<div class="field-row row">
											<div class="large-4 column end show-markup">
							...
							<div class="row">
								<div class="large-12 column">
									...
									<p>
										All form fields must have associated labels. There
										are situations where labels may be hidden:
									</p>
									<ul>
										<li>
											When a form contains only one field and a heading is used
											to describe the field. This is most common in event elements.
										</li>
									</ul>
								</div>
							</div>
							...
							<div class="row">
								<div class="large-12 column">
									...
									<p>
										Sometimes the default form fields do not provide the functionality
										or features required by the elements or forms throughout the application.
									</p>
									<p>
										It's important to be familiar with these custom fields so that
										they can re-used appropriately when required.
									</p>
									...
									<div class="example" id="highlight-example">
										...
										<p>
											A highlighted field may be used to show validation errors or
											to show different levels of importanance.
										</p>
										<h4>Example:</h4>
										<div class="field-row row">
											<div class="large-4 column end show-markup">
									...
									<div class="example" id="select-search-example">
										...
										<p>
											A select search component is a combination of a default
											select dropdown with an option to search for additional options.
										</p>
										<h4>When to use:</h4>
										<p>
											When displaying a reduced list of common and relevant options from a massive list in a select dropdown,
											and allowing the user to search for additional options within the massive list.
										</p>
										<h4>Example:</h4>
										<div class="field-row row">
											<div class="large-4 column end show-markup">
